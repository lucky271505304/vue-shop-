    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="params.categoryName">{{params.categoryName}}<i @click="removeName">X</i></li>
             <li class="with-x" v-if="params.keyword">{{params.keyword}}<i @click="removeKey">X</i></li>
             <li class="with-x" v-if="params.trademark">{{params.trademark.split(':')[1]}}<i @click="removeBrand">X</i></li>
             <li class="with-x" v-for="(list3,index) in params.props" :key="index">{{list3.split(':')[1]}}<i @click="removeAttr(index)">X</i></li>
          </ul>
        </div>
...
<script>
  ...
  export default {
    ...
    methods:{
          ...
          tradeInfo(brand){
            this.params.trademark = `${brand.tmId}:${brand.tmName}`
            this.getDate();
          },
          attrInfo(list1,list2){
           let props = `${list1.attrId}:${list2}:${list1.attrName}`;
          ...
          sort(flag){
            ...
            let originType = this.params.order.split(':')[1];
            let newOrder = '';
            if(flag == originFlag){
