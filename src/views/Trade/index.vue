<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="list1 in orderInfo.detailArrayList" :key="list1.skuId">
          <li>
            <img :src="list1.imgUrl" alt="" style="width:100px;height:100px;">
          </li>
          <li>
            <p>{{list1.skuName}}</p>
            <h4>7天无理由退货</h4>
  ...
  export default {
    ...
    methods:{
      ...
      async  submitOrder(){
          ...
          let data= {
          consignee: this.userAddress.consignee, //付款人的名字
          consigneeTel: this.userAddress.phoneNum, //付款人的手机号
          deliveryAddress: this.userAddress.fullAddress, //付款人收货地址
